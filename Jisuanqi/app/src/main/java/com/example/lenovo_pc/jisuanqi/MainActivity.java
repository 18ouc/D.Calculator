...
// 绑定 加 号 的监听事件
        btn_jia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NumberFormat nf = NumberFormat.getInstance();
                nf.setMaximumFractionDigits(15);
                textView.setText(String.valueOf(nf.format(sum)));//修补了 0.00按四则运算符后的bug
        ...
        btn_tuiwei.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(sum == sum1 && (sum != sum2 || (sum == 0 && first.indexOf(".")!= -1)) &&/*second == ""&& */first != "" && ppt == 0&&aaa ==0) {//v用于控制平方 开方 倒数
                    ...
                    if (len1 == 1 || (len1 == 2 && (first.indexOf("-") != -1 || first.indexOf(".") != -1))||(len1 == 3 && first.indexOf("-") != -1 && first.indexOf(".") != -1 &&first.indexOf("0") != -1) ){
                        first = "0";
                        textView.setText(first);
                        flag = true;//新加*********************************
                    }
                    ...
                    if (len2 == 1 || (len2 == 2 && (second.indexOf("-") != -1|| second.indexOf(".") != -1))||(len2 == 3 && second.indexOf("-") != -1 && second.indexOf(".") != -1 && second.indexOf("0") != -1)) {
                        second = "0";
                        textView.setText(second);
                        flag = true;//新加*********************************
                    }
